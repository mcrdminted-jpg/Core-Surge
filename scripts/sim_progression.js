...
const RANK_DEFS = {
  ...
  thorns:     { cost0:45, costMul:1.15, maxRank:12, family:'spikedCore' },
  knockback:  { cost0:60, costMul:1.16, maxRank:8,  family:'knockbackSystems' },
...
const UNLOCK_FAMILIES_ORDER = [
  ...
  { id: 'spikedCore', cost: 6000 },
  { id: 'knockbackSystems', cost: 8000 },
